...
export default function HomeSection() {
  return (
    <section  className="text-center py-15  bg-black px-5">
                ...
                <h2 className="text-gray-300 text-3xl mb-10">Frontend Developer crafting modern UI</h2>
                <p className="text-gray-400 text-xl mb-5">Crafting beautiful digital experiences with modern web
                    technologies</p>
