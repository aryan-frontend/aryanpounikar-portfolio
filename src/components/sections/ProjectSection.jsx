                ...
                <div className="grid md:grid-cols-3 grid-cols-1 gap-10 text-white mt-18">
                    <div
                        className="border-2 border-gray-800 hover:border-blue-900  rounded-3xl overflow-hidden hover:-translate-y-4 transition-transform duration-1000">
                            <Image src={ecommerce} alt='ecommerceimg'/>
                        <div className="p-4">
                            <h3 className="text-2xl font-bold">ShopHub - E-commerce Website</h3>
                            <p className="text-gray-400 my-3 text-justify ">
                                A fully responsive eCommerce website designed to deliver a seamless online shopping
                                experience. It includes product listings, filtering, cart functionality, and a smooth
                                checkout interface. Built using modern frontend technologies, the platform focuses on
                                performance, usability, and clean UI design.
                            </p>
                            <a href="https://shophub-dun-six.vercel.app" target="_blank"
                                className="border-2 border-blue-900 px-3 py-1 rounded-xl m-1">Live Demo</a>

                            <a href="https://github.com/aryan-frontend/shophub" target="_blank"
